...
class CurlClient implements ClientInterface
{
        ...
        switch ($errno) {
            ...
            case \CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Stripe ({$url}).  Please check your "
                 . 'internet SQLConnection and try again.  If this problem persists, '
    ...
    private function shouldRetry($errno, $rcode, $rheaders, $numRetries)
    {
        ...
        // Destination refused the SQLConnection, the SQLConnection was reset, or a
        // variety of other SQLConnection failures. This could occur from a single
